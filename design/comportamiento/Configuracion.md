# Comportamiento · Configuración del negocio
...
|---|---|
| Patrón | Core |
| Móvil | `design/pantallas/ConfiguracionMovil.html` |
| Web | `design/pantallas/ConfiguracionWeb.html` |
| Paquete Flutter | `packages/core` |
| Microservicio | `servicio-usuarios` |
| Tablas | `configuracion_negocio` · `impuestos` · `sucursales` · `negocios` |
| Historias | HU-018 (Configuración fiscal y de operación del negocio) · HU-019 (Sucursales y bodegas del negocio) |
