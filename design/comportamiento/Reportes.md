# Comportamiento · Reportes y dashboards
...
|---|---|
| Patrón | Core |
| Móvil | `design/pantallas/ReportesMovil.html` |
| Web | `design/pantallas/ReportesWeb.html` |
...
| Historias | HU-098 (Reportes de ventas, márgenes y rotación) |
