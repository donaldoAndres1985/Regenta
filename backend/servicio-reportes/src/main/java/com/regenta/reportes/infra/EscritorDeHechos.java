...
public class EscritorDeHechos {
    ...
    public void insertarComanda(UUID negocioId, int fechaId, OffsetDateTime ocurridoEn, Long sucursalSk,
            Long usuarioSk, UUID comandaId, UUID mesaId, String mesaCodigo, Integer numComensales,
            UUID itemMenuId, String itemNombre, BigDecimal cantidad, BigDecimal montoNeto,
            BigDecimal costo, BigDecimal propina, Integer tiempoPreparacionMin, Integer tiempoMesaMin) {
        jdbc.update("""
                INSERT INTO reportes.hechos_comanda (negocio_id, fecha_id, ocurrido_en, sucursal_sk, usuario_sk,
                    comanda_id, mesa_id, mesa_codigo, num_comensales, item_menu_id, item_nombre, cantidad,
                    monto_neto, costo, propina, tiempo_preparacion_min, tiempo_mesa_min)
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """,
                negocioId, fechaId, ocurridoEn, sucursalSk, usuarioSk, comandaId, mesaId, mesaCodigo,
                numComensales, itemMenuId, itemNombre, cantidad, montoNeto, costo, propina,
